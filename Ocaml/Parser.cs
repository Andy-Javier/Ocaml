...
public class Parser
{
    ...
    public void Parse()
    {
        ...
        while (!IsAtEnd())
        {
            try
            {
                ...
                // ¡IMPORTANTE! Avanza el token para evitar quedarte pegado
                if (!IsAtEnd())
                    Advance();
            }
            catch (Exception ex)
    ...
    private Expr ParseLogicalOr()
    {
        ...
        while (Match(TokenType.Operator, "||"))
        {
            ...
            expr = new CallExpr(new IdentifierExpr("or"), new CallExpr(expr, right)); // simulo función "or"
        }
    ...
    private Expr ParseLogicalAnd()
    {
        ...
        while (Match(TokenType.Operator, "&&"))
        {
            ...
            expr = new CallExpr(new IdentifierExpr("and"), new CallExpr(expr, right)); // simulo función "and"
        }
